...
Le temps d'exécution diminue en fonction du nombre de workers quand on en a deux, cependant il ne semble ne pas être efficace avec 4 workers, notamment quand il n'y a pas de partitionnement, peut être dû à un echange d'informations entre workers.
