...
if __name__ == "__main__":
    ...
    ranks.coalesce(1).write.mode("overwrite").csv(output_path)
    ...
    spark.createDataFrame([(elapsed_time,)], ["elapsed_time"]).coalesce(1).write.mode("overwrite").csv(timer_output_path)
